                  ...
                  <div className="grid gap-4 sm:grid-cols-2">
                    <div className="space-y-2">
                      ...
                      <Select value={formData.service} onValueChange={(value) => handleInputChange("service", value)}>
                        ...
                        <SelectContent className="bg-slate-800 border-slate-600 z-50">
                          ...
                          <SelectItem value="metaads" className="text-white hover:bg-purple-600 focus:bg-purple-600 focus:text-white text-sm sm:text-base">Meta Ads Setup</SelectItem>
                        </SelectContent>
                      </Select>
                    </div>
                    ...
                    <div className="space-y-2">
                      ...
                      <Select value={formData.budget} onValueChange={(value) => handleInputChange("budget", value)}>
                        ...
                        <SelectContent className="bg-slate-800 border-slate-600 z-50">
                          <SelectItem value="₹10,000-₹15,000" className="text-white hover:bg-pink-600 focus:bg-pink-600 focus:text-white text-sm sm:text-base">₹10,000-₹15,000</SelectItem>
                          <SelectItem value="₹15,000-₹20,000" className="text-white hover:bg-pink-600 focus:bg-pink-600 focus:text-white text-sm sm:text-base">₹15,000-₹20,000</SelectItem>
                          <SelectItem value="₹25,000-₹30,000" className="text-white hover:bg-pink-600 focus:bg-pink-600 focus:text-white text-sm sm:text-base">₹25,000-₹30,000</SelectItem>
                          <SelectItem value="₹30,000+" className="text-white hover:bg-pink-600 focus:bg-pink-600 focus:text-white text-sm sm:text-base">₹30,000+</SelectItem>
